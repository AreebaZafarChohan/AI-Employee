...
from src.utils.cross_dedup import CrossSourceDedup  # noqa: E402
...
class LinkedInWatcher:
    ...
    def create_needs_action_file(self, item: dict) -> Optional[Path]:
        ...
        if _cross_dedup.is_duplicate(item["content"], "linkedin"):
            logger.debug(f"Cross-source duplicate skipped: {item_id}")
            return None
